...
HashMap<String, GameEvent> games = new HashMap<>();
    ...
    public static void main(String[] args) throws Exception {
        ...
        commands.addCommands(
                Commands.slash("greg_help", "Help with gregbot")
                        .setContexts(InteractionContextType.ALL)
                        .setIntegrationTypes(IntegrationType.ALL)
                        .addOption(STRING, "command", "The command to get help with", false)
        );
        ...
        switch (event.getModalId()) {
            ...
            case "event_modal_2":
                ...
                if (games.containsKey(event.getUser().getId())) {
                    ...
                    + "the GameEvent wasn't present in hashmap when modal_2 was submited").setEphemeral(true).queue();
                    return;
                }
        ...
        event.replyModal(Modal.create("event_modal_1", "Create an event")
                .addComponents(
                        ...
                        ActionRow.of(TextInput.create("description", "Description", TextInputStyle.PARAGRAPH)
                                ...
                                .setMaxLength(500)
                                .build()),
                        ActionRow.of(TextInput.create("repeats", "How often does the game repeat?", TextInputStyle.SHORT)
    ...
    public void createModalTwo(ButtonInteractionEvent event) {
        event.replyModal(Modal.create("event_modal_2", "Create an event, part 2")
                .addComponents(
                        ActionRow.of(TextInput.create("timezone", "Timezone Code, /greg_help tz", TextInputStyle.SHORT)
                                .setPlaceholder("UTC")
                                .setMinLength(2)
                                .setMaxLength(5)
                                .build()),
                        ActionRow.of(TextInput.create("start_time", "Starts at 'YY-MM-DD-HH-mm' (24 hour time)", TextInputStyle.SHORT)
                                .setPlaceholder("2026-01-01-13-00")
                                .setMinLength(16)
                                .setMaxLength(16)
                                .build()),
                        ActionRow.of(TextInput.create("end_time", "Ends at 'YYYY-MM-DD-HH-mm' (24 hour time)", TextInputStyle.SHORT)
                                .setPlaceholder("2026-01-01-16-15")
                                .setMinLength(16)
                                .setMaxLength(16)
                                .build()),
                        ActionRow.of(TextInput.create("signup_close_time", "Cut-off time for signing up", TextInputStyle.SHORT)
